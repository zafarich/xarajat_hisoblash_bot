...
bot.command("start", async (ctx) => {
  ...
  await returnHomePageButtons(
    `Guruhlar o'rtasida xarajatlar hisob-kitobini amalga oshiruvchi botga xush kelibsiz\n\nBu bot orqali siz guruhdoshlar(kvartiradoshlar) o'rtasida qilingan xarajatlarni oson va avtomatlashtirilgan holda hisob-kitob qilishingiz mumkin\n\nFoydalanish:\n\n1. Guruh yaratishni bosing va guruh nomini kiriting\n\n2. Bot sizga boshqa guruhdoshlaringiz qo'shilishi uchun havola beradi. Shu havolani qo'shilishi kerak bo'lgan odamlarga jo'natasiz va ular shu orqali guruhga qo'shiladi\n\n3. Xarajat yozish - bu bo'limda siz qilgan xarajatingizni yozishingiz mumkin\n\n4. Hisob-kitob - bu bo'limda oldi-berdi xarajatlari hisob-kitob qilinadi\n\n5. Mening xarajatlarim - o'zingizning xarajatlaringizni ko'rishingiz va o'chirishingiz mumkin\n\n6. Umumiy - umumiy kim qancha xarajat yozganini ko'rish mumkin\n\n7. Guruh boshqaruvi - guruh xarajatlarini tozalash, nomini o'zgartirish, foydalanuvchilarni chiqarib tashlash, guruhni o'chirish kabi amallarini bajarishingiz mumkin\n`,
    ctx
  );
});
